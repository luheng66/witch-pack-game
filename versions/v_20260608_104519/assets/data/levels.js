...
import { levelItemsTable, getLevelItems } from './level-items.js';
...
export const getLevelConfig = (index) => {
  ...
  return {
    ...
    itemsTotalScore: current.itemsTotalScore || previous?.itemsTotalScore || 0,
    ...
    availableItems: getLevelItems(current.id)
  };
};